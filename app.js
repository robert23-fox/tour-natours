...
// Middleware to make `user` available in Pug templates
app.use((req, res, next) => {
  res.locals.user = req.user; // ✅ This ensures `user` is always available
  next();
});
...
app.use(express.urlencoded({  extended: true, limit: "10kb"})) // to parse date from a url encoded form
